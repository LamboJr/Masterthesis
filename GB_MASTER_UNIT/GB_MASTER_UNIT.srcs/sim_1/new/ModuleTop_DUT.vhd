...
Port(--sysclk : in STD_LOGIC;
    ...
    PL_to_PS_BUFFER : out STD_LOGIC_VECTOR ( 31 downto 0 );
    PS_to_PL_BUFFER : in STD_LOGIC_VECTOR ( 31 downto 0 )
    );
end ModuleTop_DUT;

architecture behav of ModuleTop_DUT is
 ...
 begin
    if rising_edge(clk) then
       if rst = '1' then
        ...
        BRAM_Controller_Addr <= BRAM_PORTA_0_addr;
        clk <= BRAM_PORTA_0_clk ;
        BRAM_Controller_data_out <= BRAM_PORTA_0_din;
        BRAM_PORTA_0_dout <= BRAM_Controller_data_in ;
        BRAM_Controller_en <= BRAM_PORTA_0_en;
        rst <= BRAM_PORTA_0_rst;
        BRAM_Controller_wr_en <= BRAM_PORTA_0_we; 
