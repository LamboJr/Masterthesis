...
#
# Script generated by Vivado on Wed Dec 06 12:00:02 CET 2023
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : GB_UNIT_design.sh
...
#
# Usage        : GB_UNIT_design.sh
#                GB_UNIT_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                GB_UNIT_design.sh [-reset_run]
#                GB_UNIT_design.sh [-reset_log]
#                GB_UNIT_design.sh [-help]
#
...
#                script (type 'GB_UNIT_design.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname axi_bram_ctrl_v4_1_8 -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_13 -libname axi_lite_ipif_v3_0_4 -libname interrupt_control_v3_1_4 -libname axi_gpio_v2_0_30 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xil_defaultlib axi_bram_ctrl_v4_1_8 lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_4 axi_gpio_v2_0_30)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "GB_UNIT_design.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./GB_UNIT_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../GB_MASTER_UNIT.gen/sources_1/bd/GB_UNIT_design/ipshared/ec67/hdl" +incdir+"../../../../GB_MASTER_UNIT.gen/sources_1/bd/GB_UNIT_design/ipshared/aed8/hdl" +incdir+"../../../../GB_MASTER_UNIT.gen/sources_1/bd/GB_UNIT_design/ipshared/f0b6/hdl/verilog" +incdir+"../../../../GB_MASTER_UNIT.gen/sources_1/bd/GB_UNIT_design/ipshared/66be/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../GB_MASTER_UNIT.gen/sources_1/bd/GB_UNIT_design/ipshared/ec67/hdl" +incdir+"../../../../GB_MASTER_UNIT.gen/sources_1/bd/GB_UNIT_design/ipshared/aed8/hdl" +incdir+"../../../../GB_MASTER_UNIT.gen/sources_1/bd/GB_UNIT_design/ipshared/f0b6/hdl/verilog" +incdir+"../../../../GB_MASTER_UNIT.gen/sources_1/bd/GB_UNIT_design/ipshared/66be/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.GB_UNIT_design xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.GB_UNIT_design -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/daniel/Masterthesis/GB_MASTER_UNIT/GB_MASTER_UNIT.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log GB_UNIT_design_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./GB_UNIT_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: GB_UNIT_design.sh [-help]\n\
Usage: GB_UNIT_design.sh [-step]\n\
Usage: GB_UNIT_design.sh [-lib_map_path]\n\
Usage: GB_UNIT_design.sh [-reset_run]\n\
Usage: GB_UNIT_design.sh [-reset_log]\n\
Usage: GB_UNIT_design.sh [-keep_index]\n\
Usage: GB_UNIT_design.sh [-noclean_files]\n\n\
