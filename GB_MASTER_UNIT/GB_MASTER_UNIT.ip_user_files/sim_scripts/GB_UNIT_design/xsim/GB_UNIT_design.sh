...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_bram_ctrl_v4_1_8 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_4 -L axi_gpio_v2_0_30 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot GB_UNIT_design xil_defaultlib.GB_UNIT_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim GB_UNIT_design -key {Behavioral:sim_1:Functional:GB_UNIT_design} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5375.protoinst" -protoinst "protoinst_files/GB_UNIT_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb GB_UNIT_design.wdb xsim.dir libdpi.so)
