...
HD_PWD='/home/daniel/Masterthesis/GB_MASTER_UNIT/GB_MASTER_UNIT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ModuleTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ModuleTop.tcl
